...
# Dumpling Overview {#dumpling-overview}
...
## Improvements of Dumpling compared with Mydumper {#improvements-of-dumpling-compared-with-mydumper}
...
## Dumpling introduction {#dumpling-introduction}
...
## Export data from TiDB/MySQL {#export-data-from-tidb-mysql}
...
### Export historical data snapshot of TiDB {#export-historical-data-snapshot-of-tidb}
...
### TiDB GC settings when exporting a large volume of data (more than 1 TB) {#tidb-gc-settings-when-exporting-a-large-volume-of-data-more-than-1-tb}
